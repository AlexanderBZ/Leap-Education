...
export default function TermsConditionsPage() {
  return (
    <Fragment>
      <Head>
        <title>Leap Education | Terms and Conditions</title>
        <meta
          name="description"
          content="In addition, when you use any current, future Leap Education Services, you also will be subject to the guidelines, terms and agreements (“Terms”) ..."
        />
      </Head>
      ...
      <div className={classes.container}>
        ...
        <h2>
          <strong>Agreement between User and www.leapeducation.com</strong>
        </h2>
        <p>
          Welcome to www.leapeducation.com. The www.leapeducation.com website
          (the &quot;Site&quot;) is comprised of various web pages operated by
          Leap Education. www.leapeducation.com is offered to you conditioned on
          your acceptance without modification of the terms, conditions, and
          notices contained herein (the &quot;Terms&quot;). Your use of
          www.leapeducation.com constitutes your agreement to all such Terms.
          Please read these terms carefully, and keep a copy of them for your
          reference.
        </p>
        <p>www.leapeducation.com is a News and Information Site.</p>
        <p>
          The Leap Education website is a news and review website. We provide
          the latest news and critical consensus of albums to users. Users can
          also provide their own reviews of albums using our 5 star system.
        </p>
        <h2>
          <strong>Electronic Communications</strong>
        </h2>
        <p>
          Visiting www.leapeducation.com or sending emails to Leap Education
        ...
        <p>
          ...
          entity. You acknowledge that Leap Education is not responsible for
          third party access to your account that results from theft or
          misappropriation of your account. Leap Education and its associates
        ...
        <p>
          Leap Education does not knowingly collect, either online or offline,
          personal information from persons under the age of thirteen. If you
          are under 18, you may use www.leapeducation.com only with permission
        ...
        <p>
          www.leapeducation.com may contain links to other websites
          (&quot;Linked Sites&quot;). The Linked Sites are not under the control
          of Leap Education and Leap Education is not responsible for the
          ...
          Site. Leap Education is providing these links to you only as a
          convenience, and the inclusion of any link does not imply endorsement
          by Leap Education of the site or any association with its operators.
        </p>
        <p>
          Certain services made available via www.leapeducation.com are
          delivered by third party sites and organizations. By using any
          product, service or functionality originating from the
          www.leapeducation.com domain, you hereby acknowledge and consent that
          Leap Education may share such information and data with any third
          party with whom Leap Education has a contractual relationship to
          provide the requested product, service or functionality on behalf of
          www.leapeducation.com users and customers.
        </p>
        <h2>
        ...
        <p>
          ...
          to access and use www.leapeducation.com strictly in accordance with
          these terms of use. As a condition of your use of the Site, you
          warrant to Leap Education that you will not use the Site for any
        ...
        <p>
          ...
          used on the Site, is the property of Leap Education or its suppliers
        ...
        <p>
          ...
          Leap Education content is not for resale. Your use of the Site does
          ...
          content without the express written permission of Leap Education and
          ...
          express or implied, to the intellectual property of Leap Education or
        ...
        <p>
          Leap Education has no obligation to monitor the Communication
          Services. However, Leap Education reserves the right to review
          materials posted to a Communication Service and to remove any
          materials in its sole discretion. Leap Education reserves the right to
          terminate your access to any or all of the Communication Services at
          any time without notice for any reason whatsoever.
        </p>
        <p>
          Leap Education reserves the right at all times to disclose any
          ...
          to remove any information or materials, in whole or in part, in Leap
        ...
        <p>
          ...
          Service. Leap Education does not control or endorse the content,
          messages or information found in any Communication Service and,
          therefore, Leap Education specifically disclaims any liability with
          ...
          are not authorized Leap Education spokespersons, and their views do
          not necessarily reflect those of Leap Education.
        </p>
        <p>
        ...
        <h2>
          <strong>
            Materials Provided to www.leapeducation.com or Posted on Any Leap
            Education Web Page
          </strong>
        </h2>
        <p>
          Leap Education does not claim ownership of the materials you provide
          to www.leapeducation.com (including feedback and suggestions) or post,
          upload, input or submit to any Leap Education Site or our associated
          services (collectively &quot;Submissions&quot;). However, by posting,
          uploading, inputting, providing or submitting your Submission you are
          granting Leap Education, our affiliated companies and necessary
          sublicensees permission to use your Submission in connection with the
          operation of their Internet businesses including, without limitation,
          the rights to: copy, distribute, transmit, publicly display, publicly
        ...
        <p>
          ...
          Submission, as provided herein. Leap Education is under no obligation
          to post or use any Submission you may provide and may remove any
          Submission at any time in Leap Education's sole discretion.
        </p>
        <p>
        ...
        <p>
          ...
          accounts. By connecting your Leap Education account to your third
        ...
        <p>
          The Service is controlled, operated and administered by Leap Education
          ...
          local laws. You agree that you will not use the Leap Education Content
          accessed through www.leapeducation.com in any country or in any manner
        ...
        <p>
          You agree to indemnify, defend and hold harmless Leap Education, its
          ...
          rules or regulations. Leap Education reserves the right, at its own
          ...
          fully cooperate with Leap Education in asserting any available
          defenses.
        </p>
        <h2>
        ...
        <p>
          ...
          Further, unless both you and Leap Education agree otherwise, the
        ...
        <p>
          ...
          ERRORS. CHANGES ARE PERIODICALLY ADDED TO THE INFORMATION HEREIN. Leap
          Education AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN
          THE SITE AT ANY TIME.
        </p>
        <p>
          Leap Education AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
          ...
          OR CONDITION OF ANY KIND. Leap Education AND/OR ITS SUPPLIERS HEREBY
        ...
        <p>
          ...
          Leap Education AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
          ...
          STRICT LIABILITY OR OTHERWISE, EVEN IF Leap Education OR ANY OF ITS
        ...
        <p>
          Leap Education reserves the right, in its sole discretion, to
          ...
          of Georgia and you hereby consent to the exclusive jurisdiction and
          venue of courts in Georgia in all disputes arising out of or relating
          to the use of the Site. Use of the Site is unauthorized in any
        ...
        <p>
          ...
          relationship exists between you and Leap Education as a result of this
          agreement or use of the Site. Leap Education's performance of this
          agreement is subject to existing laws and legal process, and nothing
          contained in this agreement is in derogation of Leap Education's right
          ...
          to or gathered by Leap Education with respect to such use. If any part
        ...
        <p>
          ...
          entire agreement between the user and Leap Education with respect to
          ...
          and Leap Education with respect to the Site. A printed version of this
        ...
        <p>
          Leap Education reserves the right, in its sole discretion, to change
          the Terms under which www.leapeducation.com is offered. The most
          current version of the Terms will supersede all previous versions.
          Leap Education encourages you to periodically review the Terms to stay
        ...
        <p>
          Leap Education welcomes your questions or comments regarding the
          Terms:
        </p>
        <p>Leap Education</p>
        <p>Atlanta, Georgia 30326</p>
        <p>Email Address:</p>
        <p>www.leapeducation.com</p>
